...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2024-10-20T16:46:55Z"), OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2024-11-15T15:26:15Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2024-11-10T14:30:05Z"), OrderStatus.WAITING_PAYMENT, u1);
		...
		Payment pay1 = new Payment(null, Instant.parse("2024-10-22T16:46:55Z"), o1);
		o1.setPayment(pay1);
